...
def main():
    ...
    ap.add_argument("-d", "--path", required = True, help = "Path to directory of files") #The input option 
    ap.add_argument("-s", "--subset", required = False, help = "Subset option") #The subset option, required is F here
